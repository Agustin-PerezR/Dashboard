...
_Generado automáticamente el 2026-08-21T14:49:49.554Z -- no editar a mano, se sobreescribe en cada publicación._
...
`SCRUM_API_URL` es `http://10.24.205.242:3000`. Se generó sola a partir de la URL con la que tu
