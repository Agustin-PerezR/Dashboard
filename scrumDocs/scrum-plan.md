...
_Generado automáticamente el 2026-09-04T13:02:13.068Z — no editar a mano, se sobreescribe en cada publicación._
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | RF-01 | Registro e Inicio de Sesión de Usuario | HU-01 | — | — | Hecho ✓ dev | dev-dashboard | — | — |
| 2 | RF-02 | Recuperación de Contraseña mediante Correo Electrónico | HU-01 | — | — | Haciendo | dev-dashboard | — | — |
...
### RF-01 — Visualización del Tablero Kanban y Columnas de Estado
- Estimado: 0h
